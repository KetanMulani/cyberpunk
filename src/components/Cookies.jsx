function Cookies({ show, setShow }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      ...
      <div className="bg-black border border-orange-500/40 rounded-xl p-8 w-[90%] max-w-[600px] shadow-[0_0_30px_rgba(255,140,0,0.2)]">

        { }
        <h2 className="text-white text-[28px] font-bold mb-4 font-exo">
          Cookie Preferences
        </h2>

        { }
        <p className="text-gray-300 leading-8 mb-8 font-rajdhani">
